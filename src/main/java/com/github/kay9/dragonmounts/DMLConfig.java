...
public class DMLConfig
{
    ...
    static
    {
        ...
        BREATH_RANGE = configurator.comment("The max distance a dragon breath projectile can travel. Default is 40.0 blocks.")
                .defineInRange("global_breath_range", 40.0, 1.0, Double.MAX_VALUE);
